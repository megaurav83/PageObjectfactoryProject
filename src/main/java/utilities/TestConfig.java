...
public class TestConfig{
	...
	public static String from = "gaurav83.eoi@gmail.com";
	public static String password = "Aaron@123";
	public static String[] to ={"megaurav83@gmail.com","gaurav83.selenium@gmail.com"};
